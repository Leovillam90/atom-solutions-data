...
export default function Seccion6({ 
  ...
  colorKicker = '!text-[#091A23]',
  colorTitulo = '!text-[#051F1A]',
  colorSubtitulo = '!text-[#1E293B]'
}: Seccion6Props) {
  return (
      ...
      <div className="relative max-w-7xl mx-auto rounded-3xl overflow-hidden p-8 sm:p-12 lg:p-16 border border-[#0DEDC0]/40 shadow-[0_25px_60px_rgba(0,0,0,0.5)]">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <Kicker className={`mb-3 ${colorKicker}`}>
              AUDITORÍA FINANCIERA
            </Kicker>

            <H2 className={`text-balance mb-4 ${colorTitulo}`}>
              ATOM no te cuesta dinero, <br className="hidden sm:inline" />
              te lo multiplica.
            </H2>

            <Subtitulo className={`max-w-xl mb-8 leading-relaxed font-medium ${colorSubtitulo}`}>
              Nuestros proveedores recuperan en promedio un{' '}
              <strong className="font-black text-[#1D2935]">
                15% de ganancia real
              </strong>{' '}
              que tenían perdida en la calle durante sus primeros 30 días de operación.
            </Subtitulo>
            ...
            <div className="w-full max-w-md bg-[#091A23]/95 backdrop-blur-md rounded-2xl p-6 border border-[#0DEDC0]/40 shadow-[0_20px_40px_rgba(0,0,0,0.4)] text-white space-y-6">
              ...
              <div className="flex items-end justify-between gap-3 h-44 pt-4 px-2">
                ...
                <div className="flex-1 flex flex-col items-center gap-2 h-full justify-end group cursor-pointer">
                  <div 
                    className="w-full bg-slate-800 group-hover:bg-slate-700 rounded-t-lg h-[25%] transition-all duration-300 animate-bar-rise"
                ...
                <div className="flex-1 flex flex-col items-center gap-2 h-full justify-end group cursor-pointer">
                  <div 
                    className="w-full bg-[#6884C5]/40 group-hover:bg-[#6884C5]/70 rounded-t-lg h-[40%] transition-all duration-300 animate-bar-rise"
                ...
                <div className="flex-1 flex flex-col items-center gap-2 h-full justify-end group cursor-pointer">
                  <div 
                    className="w-full bg-[#6884C5] group-hover:bg-[#8B5CF6] rounded-t-lg h-[60%] transition-all duration-300 animate-bar-rise"
                    style={{ animationDelay: '400ms' }}
                  />
                  <span className="text-[9px] font-mono text-slate-400 group-hover:text-slate-200 transition-colors">Sem 3</span>
                </div>

                {/* BARRA 4: SEM 4 (DESTACADA Y CON RESPLANDOR NEÓN) */}
                <div className="flex-1 flex flex-col items-center gap-2 h-full justify-end group cursor-pointer">
                  <div 
                    className="w-full bg-gradient-to-t from-[#0DEDC0]/40 via-[#0DEDC0] to-white rounded-t-lg h-[95%] shadow-[0_0_20px_rgba(13,237,192,0.5)] group-hover:shadow-[0_0_30px_rgba(13,237,192,0.8)] group-hover:scale-y-[1.03] transition-all duration-300 relative animate-bar-rise"
