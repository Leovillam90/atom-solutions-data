...
const ARTICULO_DEFAULT: Articulo = {
  id: 1,
  titulo: 'El estándar logístico LATAM: Si superas estas métricas, estás perdiendo patrimonio.',
  resumen: 'Un análisis exhaustivo del equipo de analítica avanzada ATOM - Dropi revela la realidad operativa de este semestre: el promedio de devoluciones es del 20% en Colombia (25% internacional), con un 3% de pérdida física de inventario. Además, el ciclo de retorno de capital a tu wallet promedia los 10 días. Si los números de tu bodega exceden estos topes, estás subsidiando fallas logísticas que desangran tu utilidad mensual.',
  categoria:'ESTUDIO DE MERCADO',
  fecha: '1er Semestre 2026',
  tiempoLectura: 'Reporte Oficial',
  autor: 'Equipo de Analítica Avanzada ATOM',
  destacado: true,
  tagColor: '#0DEDC0',
  historias: [
    '/noticias/Activa1.jpg',
    '/noticias/Activa2.jpg',
    '/noticias/Activa3.jpg',
  ],
};
...
export default function Seccion1({
  ...
  const historias = articuloPrincipal.historias && articuloPrincipal.historias.length > 0 
    ...
    : ['/noticias/Activa1.jpg', '/noticias/Activa2.jpg', '/noticias/Activa3.jpg'];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4 pt-4 border-t border-white/10">
                ...
                <a 
                  href="https://atomapp.com.co/login"
                  target="_blank"
            ...
            <div className="lg:col-span-5 flex justify-center items-center relative py-4">
              ...
              >
                ...
                <div className="relative w-full h-full rounded-[24px] overflow-hidden bg-black flex items-center justify-center">
                  ...
                  {/* Capa 1: Fondo Desenfocado Ambiental */}
                  <img 
                    src={historias[indexHistoria]} 
                    alt="Ambient Background"
                    className="absolute inset-0 w-full h-full object-cover blur-xl opacity-40 scale-125"
                    onError={(e) => {
                      e.currentTarget.src = `/noticias/Activa${indexHistoria + 1}.png`;
                    }}
                  />

                  {/* Capa 2: IMAGEN PRINCIPAL AJUSTADA SIN CORTAR (object-contain) */}
                  <img 
                    src={historias[indexHistoria]} 
                    alt={`Estudio destacado ${indexHistoria + 1}`}
                  ...
                  <div className="absolute top-7 left-3 right-3 z-30 flex items-center justify-between pointer-events-none">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-[9px] font-mono text-[#0DEDC0] block -mt-0.5 font-bold">
                          Exclusivo Bodegas
                        </span>
                      </div>
                    </div>

                    <span className="text-[9px] font-mono font-black uppercase tracking-wider bg-red-500/80 text-white px-2 py-0.5 rounded-full border border-red-400 shadow-[0_0_10px_rgba(239,68,68,0.5)]">
                      ● LIVE
                    </span>
                  </div>
