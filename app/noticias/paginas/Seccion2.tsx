...
const ARTICULOS_DEFAULT: Articulo[] = [
  {
    id: 2,
  titulo: 'ACTUALIZACIÓN DE PLATAFORMA | 12 de Septiembre, 2026',
  resumen: 'Monitorea tu operación sin salir de tu ecosistema. Integrado en tu menú Dropi. A partir del 12 de septiembre, la plataforma toma el control total con su nuevo panel de alertas: movilización automática de guías estancadas frente a transportadoras, notificaciones automáticas a dropshippers por novedades sin resolver y actualización masiva de estados.',
