...
const ARTICULOS_DEFAULT: Articulo[] = [
  {
    id: 2,
    titulo: 'Actualización ATOM 2.0: Score de Vendedores Nativo en Dropi.',
    resumen: 'Lanzamos el nuevo algoritmo que evalúa la efectividad real de los dropshippers antes de despacharles inventario masivo. Y lo mejor: la inteligencia de ATOM ahora está 100% integrada dentro del aplicativo Dropi. Monitorea tus métricas, blinda tus despachos y toma decisiones estratégicas sin salir nunca de tu ecosistema.',
    categoria: 'INTELIGENCIA DE DATOS',
    fecha: '03 julio, 2026',
    tiempoLectura: 'Integración Nativa',
    autor: 'Producto & Tech',
    destacado: false,
    tagColor: '#6884C5',
    link: 'https://app.dropi.co/dashboard/atom/login',
    textoCta: 'VER EN DROPI →',
  },
  {
    id: 3,
  ...
  {
    id: 4,
    titulo: 'Importadora Nexus: 30% menos devoluciones fantasma en solo 60 días.',
    resumen: 'Desarmamos la estrategia operativa exacta que utilizó esta bodega para rastrear guías retenidas, frenar la fuga de capital y liberar el flujo de caja necesario para escalar su facturación al siguiente nivel.',
