...
export default function Contacto({ variante = 'spotlightCyan' }: ContactoProps) {
  return (
    <footer className="relative z-10 bg-[#091A23] text-white pt-8 pb-4 px-5 overflow-hidden border-t border-[#0DEDC0]/20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            <Kicker className="!text-[#6884C5] mb-2">Ecosistema</Kicker>
          ...
          <div>
            <Kicker className="!text-[#6884C5] mb-2">Contacto Oficial</Kicker>
            <ul className="space-y-1.5 p-0 m-0 list-none text-slate-400 text-xs">
          ...
          <div>
            <Kicker className="!text-[#6884C5] mb-2">Síguenos</Kicker>
            <div className="flex gap-2 flex-wrap">
              {SOCIAL_LINKS.map((item) => (
                <a
                  ...
                  rel="noreferrer"
                  title={item.name}
                  className="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 border cursor-pointer relative z-10 bg-white/5 border-white/10 text-white hover:border-[#0DEDC0] hover:text-[#0DEDC0] hover:-translate-y-0.5"
                >
                  {item.icon}
                </a>
              ))}
